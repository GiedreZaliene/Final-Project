...
webdriver_path = "C:/Users/juoza/OneDrive/Desktop/Naujas aplankas/chromedriver.exe"
...
for movie in movies:
    ...
    rating = movie.find('span', class_=
    'ipc-rating-star ipc-rating-star--base ipc-rating-star--imdb ratingGroup--imdb-rating').text.strip()[0:3]
    vote_count = movie.find('span', class_=
    'ipc-rating-star ipc-rating-star--base ipc-rating-star--imdb ratingGroup--imdb-rating').
    text.strip()[5:9].replace('K', '000')
